Vagrant.configure(2) do |config|
  ...
  config.vm.define :m1 do |m1|
    ...
    m1.vm.provision "shell", path: "./scripts/install-worker.sh"
  ...
  config.vm.define :m2 do |m2|
    ...
    m2.vm.provision "shell", path: "./scripts/install-worker.sh"
   ...
   config.vm.define :m3 do |m3|
    ...
    m3.vm.provision "shell", path: "./scripts/install-worker.sh"
